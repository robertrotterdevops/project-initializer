...
- **Global scope**: `/Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/notes/`)
...
2. Glob `/Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/notes/` — works in any directory
