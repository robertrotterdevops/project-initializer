...
See /Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/get-shit-done/templates/discovery.md
...
Use /Users/robert.rotter/Projects/web-app-dev/project-initializer/.claude/get-shit-done/templates/discovery.md.
