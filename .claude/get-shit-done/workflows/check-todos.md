...
node "/home/ubuntu/App-Projects-Workspace/project-initializer/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
