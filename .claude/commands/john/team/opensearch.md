...
**Model tier:** Sonnet (worker) — builds OpenSearch CRDs, ISM policies, security configs. Escalate to Opus for security plugin architecture decisions and cluster topology trade-offs.
