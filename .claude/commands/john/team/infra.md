...
**Model tier:** Sonnet (worker) — builds Terraform, Ansible, cloud-init configs. Escalate to Opus for networking design, firewall rules, and post-terraform-deploy decisions (high-risk).
