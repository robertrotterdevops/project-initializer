...
**Model tier:** Sonnet (worker) for implementation — generating contracts, templates, lifecycle policies. Escalate to Opus for engine abstraction design decisions (shared vs divergent logic).
