...
| Parameter | Value |
|---|---:|
| Hot Pool VM SKU | Standard_E16s_v5 |
| Cold Pool VM SKU | Standard_L16s_v3 |
| Frozen Pool VM SKU | Standard_E8s_v5 |
| System Pool VM SKU | Standard_D8s_v5 |
| Headroom | 25% |
| Availability Zones | 3 |
...
|---|---:|---:|---|---:|---:|---:|
| Hot Pool | 26 | 27 | 9/9/9 | 16 | 64 | 512 |
| Cold Pool | 200 | 201 | 67/67/67 | 16 | 64 | 1024 |
| Frozen Pool | 3 | 3 | 1/1/1 | 8 | 32 | 256 |
| System Pool | 12 | 12 | 4/4/4 | 8 | 32 | 128 |
| **Total** | **241** | **243** | - | - | - | - |

### Node Configuration

| Pool | VM SKU | vCPU | RAM (GB) | Disk (GB) | Proposed Naming |
|---|---|---:|---:|---:|---|
| Hot Pool | Standard_E16s_v5 | 16 | 64 | 512 | es-hot-pool-{001-027} |
| Cold Pool | Standard_L16s_v3 | 16 | 64 | 1024 | es-cold-pool-{001-201} |
| Frozen Pool | Standard_E8s_v5 | 8 | 32 | 256 | es-frozen-pool-{001-003} |
| System Pool | Standard_D8s_v5 | 8 | 32 | 128 | es-system-pool-{001-012} |
...
| Cold Pool | cold:200 | 2400.0 | 12800.0 |
| Frozen Pool | frozen:3 | 24.0 | 96.0 |
...
- Total vCPU: **3768**
- Total RAM: **15072 GB**
- Total Disk: **221952 GB**
- Snapshot Storage: **1148653.75 GB**

### Notes

> Hot pool: hot+warm+ingest data nodes + Kibana + Fleet
> Cold pool: cold data nodes (Premium SSD attached storage)
> Frozen pool: frozen data nodes (compute-optimized, minimal local disk)
> System pool: master + coordinator + ML nodes (isolated for stability)
> Headroom: 25% reserved for OS/kubelet/monitoring
> Cold tier uses Azure Premium SSD (not local NVMe) for searchable snapshots
> Azure AKS supports up to 3 availability zones per region for zone redundancy.
